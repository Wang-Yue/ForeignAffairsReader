...
struct ReaderView: NSViewRepresentable {
    ...
    func updateNSView(_ nsView: WKWebView, context: Context) {
        ...
        if context.coordinator.lastArticleId != activeArticle?.title || context.coordinator.lastLanguage != model.selectedLanguage {
            ...
            nsView.evaluateJavaScript("setFontSizeMultiplier(\(model.fontSizeMultiplier))", completionHandler: nil)
        }
    }
    ...
    private func loadArticleHTML(in webView: WKWebView, coordinator: Coordinator) {
        ...
        let imageDiv = article.image.isEmpty ? "" : """
    ...
    class Coordinator: NSObject, WKNavigationDelegate {
        ...
        func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
            ...
            webView.evaluateJavaScript("setTheme('\(parent.model.readerTheme.cssClass)')", completionHandler: nil)
            webView.evaluateJavaScript("setFontSizeMultiplier(\(parent.model.fontSizeMultiplier))", completionHandler: nil)
        }
    }
}

// Helper function for clean formatted template HTML
func getReaderHTML(title: String, subtitle: String, author: String, date: String, issue: String, imageDiv: String, body: String, theme: String, fontMultiplier: Double) -> String {
    return """
    <!DOCTYPE html>
    <html lang="en">
    <head>
